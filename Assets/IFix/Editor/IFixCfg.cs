...
public class IFixCfg
{
    ...
    static IEnumerable<Type> hotfix
    {
        get
        {
            ...
            IEnumerable<Type> firstPassCSharpList = null;
            try
            {
                // first-pass可能不存在
                firstPassCSharpList =
                    ...
                    where (type.Namespace == null
                          ...
                          (type.Namespace != null &&
                           // 以下根据命名空间排除
                           !type.Namespace.StartsWith("TrueSync") &&
            ...
            {
                Debug.Log("未找到first-pass程序集，跳过");
            }

            return firstPassCSharpList == null ? assemblyCSharpList : assemblyCSharpList.Concat(firstPassCSharpList);
        }
    }
